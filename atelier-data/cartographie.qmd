---
title: "Cartographie & Données spatiales — Formation du 11 mars"
format:
  html:
    toc: true
    toc-location: right
...
# Cartographie & données spatiales avec R
...
```{r setup-data, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
